const restaurants = [
  {
    ...
    hours: '10:30 - 21:30',
    acceptsSolo: true,
    peakPolicy: '午餐高峰可直接入座，晚餐 18:30 后偶尔需要等位',
    seatTypes: ['吧台', '单人桌'],
    counterSeats: 10,
    soloPortion: true,
    minSpend: null,
    ...
    dishes: ['葱油拌面', '番茄牛腩面', '鸡丝冷面'],
    note: '适合一个人快速吃一顿，吧台正对开放厨房。'
  },
  {
    id: 'r002',
    name: '米仓食堂',
    ...
    acceptsSolo: true,
    peakPolicy: '晚餐高峰建议避开 18:30 - 19:30',
    seatTypes: ['吧台', '普通桌'],
    counterSeats: 6,
    soloPortion: true,
    minSpend: null,
    ...
    dishes: ['照烧鸡腿定食', '盐烤鲭鱼定食', '咖喱猪排饭'],
    note: '定食分量稳定，适合不想花时间研究菜单的时候。'
  },
  {
    id: 'r003',
    name: '南风小馆',
    ...
    dishes: ['葱油拌面', '红烧肉', '虾籽大乌参'],
    note: '想吃几道本帮菜又不想去商场正餐厅，可以优先看这里。'
  },
  {
    id: 'r004',
    name: '小满饭团',
    cuisine: '快餐小吃',
    cuisineCode: 'fast_food',
    address: '乌鲁木齐中路 91 号',
    district: '静安寺',
    distance: 1150,
    priceMin: 18,
    ...
    dishes: ['梅干菜饭团', '海苔肉松饭团', '豆浆'],
    note: '预算友好，但座位有限，适合快速解决或外带。'
  },
  {
    id: 'r005',
    name: '炭町一人烧',
    ...
    dishes: ['一人牛五花套餐', '盐葱牛舌', '石锅拌饭'],
    note: '适合想认真吃一顿烧肉的人，价格和用餐时间都更高。'
  },
  {
    id: 'r006',
    name: '禾下粥铺',
    ...
    dishes: ['皮蛋瘦肉粥', '砂锅鸡丝粥', '卤味拼盘'],
    note: '基础信息较完整，但近期核验时间较久，建议到店前再次确认。'
  }
];
